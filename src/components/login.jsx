    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="bg-gray-200 rounded-2xl p-8 flex flex-col gap-4 items-center mt-5">
                ...
                <input type="text" onKeyDown={handleKeyDown} onChange={handleChange} placeholder="Cth: 0812423445356" className={`bg-white rounded-lg p-3 lg:px-20 px-10 text-center text-gray-400 ${error ? 'border border-red-400 border-solid' : ""}`} />
